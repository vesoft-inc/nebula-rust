...
) -> GraphConnectionManager<TokioTcpStream, TokioSleep, H, VersionV1>
where
...
//
impl<H> GraphConnectionManager<TokioTcpStream, TokioSleep, H, VersionV1>
where
    H: ResponseHandler + Send + Sync + 'static + Unpin,
{
...
#[async_trait]
impl<H> bb8::ManageConnection for GraphConnectionManager<TokioTcpStream, TokioSleep, H, VersionV1>
where
    H: ResponseHandler + Send + Sync + 'static + Unpin,
{
