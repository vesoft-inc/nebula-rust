...
pub mod services {
    pub mod raftex_service {
        ...
        pub enum HeartbeatExn {
            #[doc(hidden)]
            Success(crate::types::HeartbeatResponse),
            ApplicationException(::fbthrift::ApplicationException),
        }

        impl ::std::convert::From<crate::errors::raftex_service::HeartbeatError> for HeartbeatExn {
            fn from(err: crate::errors::raftex_service::HeartbeatError) -> Self {
                match err {
                    crate::errors::raftex_service::HeartbeatError::ApplicationException(aexn) => HeartbeatExn::ApplicationException(aexn),
                    crate::errors::raftex_service::HeartbeatError::ThriftError(err) => HeartbeatExn::ApplicationException(::fbthrift::ApplicationException {
                        message: err.to_string(),
                        type_: ::fbthrift::ApplicationExceptionErrorCode::InternalError,
                    }),
                }
        ...
        #[derive(Clone, Debug)]
        pub enum GetStateExn {
            #[doc(hidden)]
            Success(crate::types::GetStateResponse),
            ApplicationException(::fbthrift::ApplicationException),
        }

        impl ::std::convert::From<crate::errors::raftex_service::GetStateError> for GetStateExn {
            fn from(err: crate::errors::raftex_service::GetStateError) -> Self {
                match err {
                    crate::errors::raftex_service::GetStateError::ApplicationException(aexn) => GetStateExn::ApplicationException(aexn),
                    crate::errors::raftex_service::GetStateError::ThriftError(err) => GetStateExn::ApplicationException(::fbthrift::ApplicationException {
                        message: err.to_string(),
                        type_: ::fbthrift::ApplicationExceptionErrorCode::InternalError,
                    }),
                }
        ...
        impl ::std::convert::From<::fbthrift::ApplicationException> for GetStateExn {
            fn from(exn: ::fbthrift::ApplicationException) -> Self {
                Self::ApplicationException(exn)
            }
        }

        impl ::fbthrift::ExceptionInfo for GetStateExn {
            fn exn_name(&self) -> &'static str {
                match self {
                    Self::Success(_) => panic!("ExceptionInfo::exn_name called on Success"),
                    Self::ApplicationException(aexn) => aexn.exn_name(),
        ...
        impl ::fbthrift::ResultInfo for GetStateExn {
            fn result_type(&self) -> ::fbthrift::ResultType {
                match self {
                    Self::Success(_) => ::fbthrift::ResultType::Return,
                    Self::ApplicationException(_aexn) => ::fbthrift::ResultType::Exception,
        ...
        impl ::fbthrift::GetTType for GetStateExn {
            const TTYPE: ::fbthrift::TType = ::fbthrift::TType::Struct;
        }

        impl<P> ::fbthrift::Serialize<P> for GetStateExn
        where
            P: ::fbthrift::ProtocolWriter,
        {
            fn write(&self, p: &mut P) {
        ...
        impl<P> ::fbthrift::Deserialize<P> for GetStateExn
        where
            P: ::fbthrift::ProtocolReader,
        {
            fn read(p: &mut P) -> ::anyhow::Result<Self> {
                ...
                alt.ok_or_else(||
                    ::fbthrift::ApplicationException::new(
                        ::fbthrift::ApplicationExceptionErrorCode::MissingResult,
                        format!("Empty union {}", "GetStateExn"),
                    )
                    .into(),
                )
            }
...
pub mod client {
        ...
        S: ::fbthrift::help::Spawner,
    {
        ...
        fn _heartbeat_impl(
            &self,
            arg_req: &crate::types::HeartbeatRequest,
            rpc_options: T::RpcOptions,
        ) -> ::futures::future::BoxFuture<'static, ::std::result::Result<crate::types::HeartbeatResponse, crate::errors::raftex_service::HeartbeatError>> {
            use ::const_cstr::const_cstr;
            use ::tracing::Instrument as _;
            use ::futures::FutureExt as _;
            ...
            const_cstr! {
                SERVICE_NAME = "RaftexService";
                METHOD_NAME = "RaftexService.heartbeat";
            }
            let args = self::Args_RaftexService_heartbeat {
                req: arg_req,
                _phantom: ::std::marker::PhantomData,
            };
            ...
            let call = transport
                .call(SERVICE_NAME.as_cstr(), METHOD_NAME.as_cstr(), request_env, rpc_options)
                .instrument(::tracing::trace_span!("call", function = "RaftexService.heartbeat"));

            async move {
                let reply_env = call.await?;

                let de = P::deserializer(reply_env);
                let (res, _de): (::std::result::Result<crate::services::raftex_service::HeartbeatExn, _>, _) =
                    ::fbthrift::help::async_deserialize_response_envelope::<P, _, S>(de).await?;

                let res = match res {
                    ::std::result::Result::Ok(exn) => ::std::convert::From::from(exn),
                    ::std::result::Result::Err(aexn) =>
                        ::std::result::Result::Err(crate::errors::raftex_service::HeartbeatError::ApplicationException(aexn))
                };
                res
            }
            .instrument(::tracing::info_span!("RaftexService.heartbeat"))
            .boxed()
        }

        fn _getState_impl(
            &self,
            arg_req: &crate::types::GetStateRequest,
            rpc_options: T::RpcOptions,
        ) -> ::futures::future::BoxFuture<'static, ::std::result::Result<crate::types::GetStateResponse, crate::errors::raftex_service::GetStateError>> {
            use ::const_cstr::const_cstr;
            use ::tracing::Instrument as _;
            use ::futures::FutureExt as _;
            ...
            const_cstr! {
                SERVICE_NAME = "RaftexService";
                METHOD_NAME = "RaftexService.getState";
            }
            let args = self::Args_RaftexService_getState {
                req: arg_req,
                _phantom: ::std::marker::PhantomData,
            };
            ...
            // need to do call setup outside of async block because T: Transport isn't Send
            let request_env = match ::fbthrift::help::serialize_request_envelope::<P, _>("getState", &args) {
                ::std::result::Result::Ok(res) => res,
                ::std::result::Result::Err(err) => return ::futures::future::err(err.into()).boxed(),
            };
            ...
            let call = transport
                .call(SERVICE_NAME.as_cstr(), METHOD_NAME.as_cstr(), request_env, rpc_options)
                .instrument(::tracing::trace_span!("call", function = "RaftexService.getState"));

            async move {
                let reply_env = call.await?;

                let de = P::deserializer(reply_env);
                let (res, _de): (::std::result::Result<crate::services::raftex_service::GetStateExn, _>, _) =
                    ::fbthrift::help::async_deserialize_response_envelope::<P, _, S>(de).await?;

                let res = match res {
                    ::std::result::Result::Ok(exn) => ::std::convert::From::from(exn),
                    ::std::result::Result::Err(aexn) =>
                        ::std::result::Result::Err(crate::errors::raftex_service::GetStateError::ApplicationException(aexn))
                };
                res
            }
            .instrument(::tracing::info_span!("RaftexService.getState"))
            .boxed()
        }
    }
    ...
    struct Args_RaftexService_heartbeat<'a> {
        req: &'a crate::types::HeartbeatRequest,
        _phantom: ::std::marker::PhantomData<&'a ()>,
    }

    impl<'a, P: ::fbthrift::ProtocolWriter> ::fbthrift::Serialize<P> for self::Args_RaftexService_heartbeat<'a> {
        #[inline]
        #[::tracing::instrument(skip_all, level = "trace", name = "serialize_args", fields(method = "RaftexService.heartbeat"))]
        fn write(&self, p: &mut P) {
            p.write_struct_begin("args");
            p.write_field_begin("req", ::fbthrift::TType::Struct, 1i16);
            ::fbthrift::Serialize::write(&self.req, p);
    ...
    struct Args_RaftexService_getState<'a> {
        req: &'a crate::types::GetStateRequest,
        _phantom: ::std::marker::PhantomData<&'a ()>,
    }

    impl<'a, P: ::fbthrift::ProtocolWriter> ::fbthrift::Serialize<P> for self::Args_RaftexService_getState<'a> {
        #[inline]
        #[::tracing::instrument(skip_all, level = "trace", name = "serialize_args", fields(method = "RaftexService.getState"))]
        fn write(&self, p: &mut P) {
            p.write_struct_begin("args");
            p.write_field_begin("req", ::fbthrift::TType::Struct, 1i16);
            ::fbthrift::Serialize::write(&self.req, p);
        ...
        T: ::fbthrift::Transport,
    {
        ...
        fn heartbeat_with_rpc_opts(
            ...
            <Self as ::std::convert::AsRef<dyn RaftexServiceExt<T>>>::as_ref(self).heartbeat_with_rpc_opts(
                arg_req,
                rpc_options,
            )
        }
        fn getState_with_rpc_opts(
            ...
            <Self as ::std::convert::AsRef<dyn RaftexServiceExt<T>>>::as_ref(self).getState_with_rpc_opts(
                arg_req,
                rpc_options,
            )
        }
...
pub mod server {
    ...
    pub trait RaftexService: ::std::marker::Send + ::std::marker::Sync + 'static {
        ...
        async fn heartbeat(
            &self,
            _req: crate::types::HeartbeatRequest,
        ) -> ::std::result::Result<crate::types::HeartbeatResponse, crate::services::raftex_service::HeartbeatExn> {
            ::std::result::Result::Err(crate::services::raftex_service::HeartbeatExn::ApplicationException(
                ::fbthrift::ApplicationException::unimplemented_method(
                    "RaftexService",
                    "heartbeat",
                ),
        ...
        async fn getState(
            &self,
            _req: crate::types::GetStateRequest,
        ) -> ::std::result::Result<crate::types::GetStateResponse, crate::services::raftex_service::GetStateExn> {
            ::std::result::Result::Err(crate::services::raftex_service::GetStateExn::ApplicationException(
                ::fbthrift::ApplicationException::unimplemented_method(
                    "RaftexService",
                    "getState",
                ),
        ...
        T: RaftexService + Send + Sync + ?Sized,
    {
        ...
        async fn heartbeat(
            &self,
            req: crate::types::HeartbeatRequest,
        ) -> ::std::result::Result<crate::types::HeartbeatResponse, crate::services::raftex_service::HeartbeatExn> {
            (**self).heartbeat(
                req,
            ).await
        ...
        async fn getState(
            &self,
            req: crate::types::GetStateRequest,
        ) -> ::std::result::Result<crate::types::GetStateResponse, crate::services::raftex_service::GetStateExn> {
            (**self).getState(
                req,
            ).await
    ...
    struct Args_RaftexService_heartbeat {
        req: crate::types::HeartbeatRequest,
    }
    impl<P: ::fbthrift::ProtocolReader> ::fbthrift::Deserialize<P> for self::Args_RaftexService_heartbeat {
        #[inline]
        #[::tracing::instrument(skip_all, level = "trace", name = "deserialize_args", fields(method = "RaftexService.heartbeat"))]
        fn read(p: &mut P) -> ::anyhow::Result<Self> {
            static ARGS: &[::fbthrift::Field] = &[
                ::fbthrift::Field::new("req", ::fbthrift::TType::Struct, 1),
            ];
            ...
            p.read_struct_end()?;
            ::std::result::Result::Ok(Self {
                req: field_req.ok_or_else(|| ::anyhow::anyhow!("`{}` missing arg `{}`", "RaftexService.heartbeat", "req"))?,
            })
        }
    }

    struct Args_RaftexService_getState {
        req: crate::types::GetStateRequest,
    }
    impl<P: ::fbthrift::ProtocolReader> ::fbthrift::Deserialize<P> for self::Args_RaftexService_getState {
        #[inline]
        #[::tracing::instrument(skip_all, level = "trace", name = "deserialize_args", fields(method = "RaftexService.getState"))]
        fn read(p: &mut P) -> ::anyhow::Result<Self> {
            static ARGS: &[::fbthrift::Field] = &[
                ::fbthrift::Field::new("req", ::fbthrift::TType::Struct, 1),
            ];
            ...
            p.read_struct_end()?;
            ::std::result::Result::Ok(Self {
                req: field_req.ok_or_else(|| ::anyhow::anyhow!("`{}` missing arg `{}`", "RaftexService.getState", "req"))?,
            })
        }
    }
            ...
            + ::std::marker::Send + ::std::marker::Sync,
    {
        ...
        #[::tracing::instrument(skip_all, name = "handler", fields(method = "RaftexService.heartbeat"))]
        async fn handle_heartbeat<'a>(
            ...
            ::fbthrift::ContextStack::pre_read(&mut ctx_stack)?;
            let _args: self::Args_RaftexService_heartbeat = ::fbthrift::Deserialize::read(p)?;
            ::fbthrift::ContextStack::on_read_data(&mut ctx_stack, &::fbthrift::SerializedMessage {
                protocol: P::PROTOCOL_ID,
                method_name: METHOD_NAME.as_cstr(),
                buffer: ::std::marker::PhantomData, // FIXME P::into_buffer(p).reset(),
            ...
            let res = match res {
                ::std::result::Result::Ok(::std::result::Result::Ok(res)) => {
                    ::tracing::info!("success");
                    crate::services::raftex_service::HeartbeatExn::Success(res)
                }
                ::std::result::Result::Ok(::std::result::Result::Err(crate::services::raftex_service::HeartbeatExn::Success(_))) => {
                    panic!(
                        "{} attempted to return success via error",
                        "heartbeat",
                    )
                ...
                ::std::result::Result::Err(exn) => {
                    let aexn = ::fbthrift::ApplicationException::handler_panic("RaftexService.heartbeat", exn);
                    crate::services::raftex_service::HeartbeatExn::ApplicationException(aexn)
                }
            };
        ...
        #[::tracing::instrument(skip_all, name = "handler", fields(method = "RaftexService.getState"))]
        async fn handle_getState<'a>(
            &'a self,
            p: &'a mut P::Deserializer,
            req_ctxt: &R,
            reply_state: ::std::sync::Arc<::std::sync::Mutex<RS>>,
            ...
            ::fbthrift::ContextStack::pre_read(&mut ctx_stack)?;
            let _args: self::Args_RaftexService_getState = ::fbthrift::Deserialize::read(p)?;
            ::fbthrift::ContextStack::on_read_data(&mut ctx_stack, &::fbthrift::SerializedMessage {
                protocol: P::PROTOCOL_ID,
                method_name: METHOD_NAME.as_cstr(),
                buffer: ::std::marker::PhantomData, // FIXME P::into_buffer(p).reset(),
            ...
            let res = match res {
                ::std::result::Result::Ok(::std::result::Result::Ok(res)) => {
                    ::tracing::info!("success");
                    crate::services::raftex_service::GetStateExn::Success(res)
                }
                ::std::result::Result::Ok(::std::result::Result::Err(crate::services::raftex_service::GetStateExn::Success(_))) => {
                    panic!(
                        "{} attempted to return success via error",
                        "getState",
                    )
                ...
                ::std::result::Result::Err(exn) => {
                    let aexn = ::fbthrift::ApplicationException::handler_panic("RaftexService.getState", exn);
                    crate::services::raftex_service::GetStateExn::ApplicationException(aexn)
                }
            };
        ...
        RS: ::fbthrift::ReplyState<P::Frame, RequestContext = R> + ::std::marker::Send + ::std::marker::Sync + 'static
    {
        ...
        fn method_idx(&self, name: &[::std::primitive::u8]) -> ::std::result::Result<::std::primitive::usize, ::fbthrift::ApplicationException> {
            match name {
                ...
                b"heartbeat" => ::std::result::Result::Ok(3usize),
                b"getState" => ::std::result::Result::Ok(4usize),
        ...
        async fn handle_method(
            ...
            match idx {
                ...
                4usize => {
                    self.handle_getState(_p, _r, _reply_state, _seqid).await
                }
                bad => panic!(
...
pub mod mock {
    pub struct RaftexService<'mock> {
        ...
        pub heartbeat: r#impl::raftex_service::heartbeat<'mock>,
        pub getState: r#impl::raftex_service::getState<'mock>,
    ...
    impl dyn super::client::RaftexService {
        pub fn mock<'mock>() -> RaftexService<'mock> {
            RaftexService {
                ...
                heartbeat: r#impl::raftex_service::heartbeat::unimplemented(),
                getState: r#impl::raftex_service::getState::unimplemented(),
    ...
    impl<'mock> super::client::RaftexService for RaftexService<'mock> {
        ...
        fn heartbeat(
            ...
            let closure: &mut dyn ::std::ops::FnMut(crate::types::HeartbeatRequest) -> _ = &mut **closure;
            ::std::boxed::Box::pin(::futures::future::ready(closure(arg_req.clone())))
        }
        fn getState(
            &self,
            ...
            let mut closure = self.getState.closure.lock().unwrap();
            let closure: &mut dyn ::std::ops::FnMut(crate::types::GetStateRequest) -> _ = &mut **closure;
            ::std::boxed::Box::pin(::futures::future::ready(closure(arg_req.clone())))
        }
    }
    ...
    mod r#impl {
        pub mod raftex_service {
            ...
            pub struct heartbeat<'mock> {
                pub(crate) closure: ::std::sync::Mutex<::std::boxed::Box<
                    dyn ::std::ops::FnMut(crate::types::HeartbeatRequest) -> ::std::result::Result<
                        crate::types::HeartbeatResponse,
                        crate::errors::raftex_service::HeartbeatError,
                    > + ::std::marker::Send + ::std::marker::Sync + 'mock,
                >>,
            }
            ...
            impl<'mock> heartbeat<'mock> {
                pub fn unimplemented() -> Self {
                    Self {
                        closure: ::std::sync::Mutex::new(::std::boxed::Box::new(|_: crate::types::HeartbeatRequest| panic!(
                            "{}::{} is not mocked",
                            "RaftexService",
                            "heartbeat",
                        ))),
                ...
                pub fn ret(&self, value: crate::types::HeartbeatResponse) {
                    self.mock(move |_: crate::types::HeartbeatRequest| value.clone());
                }

                pub fn mock(&self, mut mock: impl ::std::ops::FnMut(crate::types::HeartbeatRequest) -> crate::types::HeartbeatResponse + ::std::marker::Send + ::std::marker::Sync + 'mock) {
                    let mut closure = self.closure.lock().unwrap();
                    *closure = ::std::boxed::Box::new(move |req| ::std::result::Result::Ok(mock(req)));
                }

                pub fn mock_result(&self, mut mock: impl ::std::ops::FnMut(crate::types::HeartbeatRequest) -> ::std::result::Result<crate::types::HeartbeatResponse, crate::errors::raftex_service::HeartbeatError> + ::std::marker::Send + ::std::marker::Sync + 'mock) {
                    let mut closure = self.closure.lock().unwrap();
                    *closure = ::std::boxed::Box::new(move |req| mock(req));
                }
                ...
                pub fn throw<E>(&self, exception: E)
                where
                    E: ::std::convert::Into<crate::errors::raftex_service::HeartbeatError>,
                    E: ::std::clone::Clone + ::std::marker::Send + ::std::marker::Sync + 'mock,
                {
                    let mut closure = self.closure.lock().unwrap();
                    *closure = ::std::boxed::Box::new(move |_: crate::types::HeartbeatRequest| ::std::result::Result::Err(exception.clone().into()));
                }
            }

            pub struct getState<'mock> {
                pub(crate) closure: ::std::sync::Mutex<::std::boxed::Box<
                    dyn ::std::ops::FnMut(crate::types::GetStateRequest) -> ::std::result::Result<
                        crate::types::GetStateResponse,
                        crate::errors::raftex_service::GetStateError,
                    > + ::std::marker::Send + ::std::marker::Sync + 'mock,
                >>,
            }
            ...
            impl<'mock> getState<'mock> {
                pub fn unimplemented() -> Self {
                    Self {
                        closure: ::std::sync::Mutex::new(::std::boxed::Box::new(|_: crate::types::GetStateRequest| panic!(
                            "{}::{} is not mocked",
                            "RaftexService",
                            "getState",
                        ))),
                ...
                pub fn ret(&self, value: crate::types::GetStateResponse) {
                    self.mock(move |_: crate::types::GetStateRequest| value.clone());
                }

                pub fn mock(&self, mut mock: impl ::std::ops::FnMut(crate::types::GetStateRequest) -> crate::types::GetStateResponse + ::std::marker::Send + ::std::marker::Sync + 'mock) {
                    let mut closure = self.closure.lock().unwrap();
                    *closure = ::std::boxed::Box::new(move |req| ::std::result::Result::Ok(mock(req)));
                }

                pub fn mock_result(&self, mut mock: impl ::std::ops::FnMut(crate::types::GetStateRequest) -> ::std::result::Result<crate::types::GetStateResponse, crate::errors::raftex_service::GetStateError> + ::std::marker::Send + ::std::marker::Sync + 'mock) {
                    let mut closure = self.closure.lock().unwrap();
                    *closure = ::std::boxed::Box::new(move |req| mock(req));
                }
                ...
                pub fn throw<E>(&self, exception: E)
                where
                    E: ::std::convert::Into<crate::errors::raftex_service::GetStateError>,
                    E: ::std::clone::Clone + ::std::marker::Send + ::std::marker::Sync + 'mock,
                {
                    let mut closure = self.closure.lock().unwrap();
                    *closure = ::std::boxed::Box::new(move |_: crate::types::GetStateRequest| ::std::result::Result::Err(exception.clone().into()));
                }
            }
        }
    }
...
pub mod errors {
    ...
    pub mod raftex_service {
        ...
        impl ::std::convert::From<crate::services::raftex_service::HeartbeatExn> for
            ::std::result::Result<crate::types::HeartbeatResponse, HeartbeatError>
        {
            fn from(e: crate::services::raftex_service::HeartbeatExn) -> Self {
                match e {
                    crate::services::raftex_service::HeartbeatExn::Success(res) => {
                        ::std::result::Result::Ok(res)
                    }
        ...
        pub type GetStateError = ::fbthrift::NonthrowingFunctionError;

        impl ::std::convert::From<crate::services::raftex_service::GetStateExn> for
            ::std::result::Result<crate::types::GetStateResponse, GetStateError>
        {
            fn from(e: crate::services::raftex_service::GetStateExn) -> Self {
                match e {
                    crate::services::raftex_service::GetStateExn::Success(res) => {
                        ::std::result::Result::Ok(res)
                    }
                    crate::services::raftex_service::GetStateExn::ApplicationException(aexn) =>
                        ::std::result::Result::Err(GetStateError::ApplicationException(aexn)),
                }
            }
        }
